---
title: '비동기 프로그래밍'
description: '멀티패러다임 프로그래밍을 읽고 Promise를 값으로 다루는 관점에서 시작하여 함수형 프로그래밍과 조합한 비동기 처리 기법을 다루는 법을 알아봅니다.'
...
<PromiseRaceRenderingQuiz></PromiseRaceRenderingQuiz>
...
2. AsyncGenerator를 사용하여 구현하는 방식
