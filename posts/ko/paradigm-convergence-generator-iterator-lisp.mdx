---
title: '코드:객체:함수 = Generator:Iterator:LISP = IP:OOP:FP'
description: '멀티패러다임 프로그래밍을 읽고  명령형 코드를 함수형으로 단계별 변환하며, Generator:Iterator:LISP = IP:OOP:FP라는 등식이 성립하는 이유를 알아봅니다.'
